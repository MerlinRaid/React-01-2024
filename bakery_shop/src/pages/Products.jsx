...
function Products() {
  ...
  return (<div>
    <br /><br />
     <td><Button onClick={sortProductsByPriceAZ} type="submit" variant="success">Sort by price (ascending)</Button></td>
     <td><Button onClick={sortProductsByPriceZA} type="submit" variant="success">Sort by Price (Descending)</Button></td>
